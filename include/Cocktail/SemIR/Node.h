#ifndef COCKTAIL_SEMIR_NODE_H
#define COCKTAIL_SEMIR_NODE_H
  ...
  auto Print(llvm::raw_ostream& out) const -> void {
    switch (index) {
      ...
      case 1:
        ...
        break;
      default:
        COCKTAIL_FATAL() << "Invalid bool value " << index;
    }
  }
};
...
template <>
struct llvm::DenseMapInfo<Cocktail::SemIR::NodeBlockId>
    : public Cocktail::SemIR::IdMapInfo<Cocktail::SemIR::NodeBlockId> {};
template <>
struct llvm::DenseMapInfo<Cocktail::SemIR::NodeId>
    : public Cocktail::SemIR::IdMapInfo<Cocktail::SemIR::NodeId> {};
template <>
struct llvm::DenseMapInfo<Cocktail::SemIR::StringId>
    : public Cocktail::SemIR::IdMapInfo<Cocktail::SemIR::StringId> {};

#endif  // COCKTAIL_SEMIR_NODE_H