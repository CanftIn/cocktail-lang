#ifndef COCKTAIL_LOWER_FILE_CONTEXT_H
#define COCKTAIL_LOWER_FILE_CONTEXT_H
...
class FileContext {
 public:
  ...
  auto GetFunction(SemIR::FunctionId function_id) -> llvm::Function* {
    COCKTAIL_CHECK(functions_[function_id.index] != nullptr) << function_id;
  ...
  auto GetType(SemIR::TypeId type_id) -> llvm::Type* {
    ...
    COCKTAIL_CHECK(type_id.index >= 0) << type_id;
...
#endif  // COCKTAIL_LOWER_FILE_CONTEXT_H