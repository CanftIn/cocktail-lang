#ifndef COCKTAIL_LOWER_FUNCTION_CONTEXT_H
#define COCKTAIL_LOWER_FUNCTION_CONTEXT_H
...
class FunctionContext {
 public:
  ...
  auto GetLocal(SemIR::NodeId node_id) -> llvm::Value* {
    ...
    COCKTAIL_CHECK(it != locals_.end()) << "Missing local: " << node_id;
    return it->second;
  }
  ...
  auto SetLocal(SemIR::NodeId node_id, llvm::Value* value) {
    ...
    COCKTAIL_CHECK(added) << "Duplicate local insert: " << node_id;
  }
...
#endif  // COCKTAIL_LOWER_FUNCTION_CONTEXT_H