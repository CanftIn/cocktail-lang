#ifndef COCKTAIL_LEXNEW_TOKENIZED_BUFFER_H
#define COCKTAIL_LEXNEW_TOKENIZED_BUFFER_H
...
#include "Cocktail/LexNew/TokenKind.h"
...
#endif  // COCKTAIL_LEXNEW_TOKENIZED_BUFFER_H
